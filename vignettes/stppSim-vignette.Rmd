...
The processing time on an Intel Core i7-7500CPU @ 2.70GHz, 16.0GB RAM PC is `3.5 minutes`. The processing time is increases to `30.2` minutes, if the argument `resistance_feat = camden$landuse` (with `field = "restrVal"`). 
