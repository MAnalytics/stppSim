...
size = c(200, 1000,  2000)

artif_stpp <- psim_artif(n_events=200, start_date = "2021-01-01",
  poly=camden_boundary, n_origin=50, resistance_feat = NULL,
  field = "rValue1",
...
Based on the setting above, the followings are the spatial and the corresponding temporal patterns generated. Users are advised to explore the effects of different argument options, such as `trend` {`stable`,`increasing` or `decreasing`},  `conc_type` {`nucleated` or `dispersed`}, as well as different values of `n_origin`, and so on.  
...
Here, the `resistance_feat` is included.
