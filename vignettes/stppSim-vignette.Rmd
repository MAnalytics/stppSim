...
knitr::include_graphics(paste("fig/","origins.png",sep=""))
```
...
knitr::include_graphics(paste("fig/", "restrictionMap.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "trend.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "fromscratch.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "temporalscratch.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "onemonth.png", sep=""))
```
...
```{r fig7, echo=FALSE, out.width="100%", out.height="100%", fig.align = "center", fig.cap="Sample real data (a) unaggregated and (b) aggregated by locations"}
knitr::include_graphics(paste("fig/", "samplerealvssampleaggregated.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "simvsreal_spatial.png", sep=""))
```
...
knitr::include_graphics(paste("fig/", "simvsreal_temporal.png", sep=""))
```
...
To retrieve the plot showing the relative sizes of the two areas: 
...
knitr::include_graphics(paste("fig/", "camdenvsbirmingham.png", sep=""))
```
