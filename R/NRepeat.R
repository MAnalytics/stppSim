...
#' @param time a vector of time. This can be of type integer,
#' numeric, or date
#' @param sds A vector of break points of the spatial intervals.
...
#' @param tds A vector of break points of the temporal intervals.
#' For example c(0,2,4,Inf) to specify temporal intervals from
#' 0-2, 2-4, 4-Inf days.
#' @param s_include.lowest the descriptions above are ambiguous on
...
#' @param s_right logical, indicating if the spatial intervals should
#' be closed on the right (and open on the left) or vice versa.
#' Default = FALSE. See vignette("NearRepeat_breaks") for details.
#' @param t_include.lowest t_include.lowest follows the arguments of
...
#' @param t_right logical, indicating if the temporal intervals should
#' be closed on the right (and open on the left) or vice versa.
#' Default = FALSE. See vignette("NearRepeat_breaks") for details.
#' @param method The method to calculate the spatial distances between
...
#' @param nrep The number of replications of the Monte
#' Carlo simulation (default = 999).
#' @param saveSimulations Should all simulated contingency tables be
...
#' }
#' @details Further details available at:
#' https://github.com/wsteenbeek/NearRepeat.
#' @return An object of type "knox", i.e. a list with four tables.
